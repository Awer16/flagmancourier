...
export default function CourierLoginForm(): React.ReactElement {
  ...
  return (
    <form className="mt-8 flex flex-col gap-5" onSubmit={onSubmit} noValidate>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="courier-login-email" className={labelClass}>
          Электронная почта
        </label>
        <input
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="courier-login-password" className={labelClass}>
          Пароль
        </label>

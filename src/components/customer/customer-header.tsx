      ...
      <header className="fixed left-0 right-0 top-0 z-40 border-b border-border-soft bg-card/95 shadow-[var(--shadow-card)] backdrop-blur-sm">
        <div className="flex h-14 items-center gap-3 px-4 sm:gap-4">
          ...
          <button
            ...
            className="min-w-0 max-w-[min(100%,16rem)] shrink-0 cursor-pointer truncate text-left text-sm font-normal text-gray-500 underline-offset-2 transition-colors hover:text-gray-700 hover:underline sm:max-w-md sm:text-base"
          >
